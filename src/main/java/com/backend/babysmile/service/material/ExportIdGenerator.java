...
public class ExportIdGenerator implements IdentifierGenerator {
    @Override
    public Serializable generate(SharedSessionContractImplementor session, Object object) throws HibernateException {
        ...
        String query = String.format("SELECT MAX(export_id) FROM material_exports WHERE export_id LIKE '%s%%'", prefix);
